...
# AUTO-GENERATED — pipeline: ecommerce_data
# Do not manually edit. Use /create_pipeline endpoint to regenerate.

PIPELINE_ID     = "pipeline_ecommerce_data"
CONNECTOR_TYPE  = "csv"
...
DATASET_PIPELINE_CON  = "/opt/airflow/dataset/pipeline_ecommerce_data"
PIPELINE_CON_ROOT     = "/opt/airflow/user_data/pipeline_ecommerce_data"
